...
class TournamentMenuController:
    ...
    def __call__(self):
        ...
        self.menu.add("auto", "Créer un nouveau tournoi", NewTournamentController().new_tournament)
        self.menu.add("auto", "Ajouter des joueurs", NewTournamentController().add_players_tournament)
        self.menu.add("auto", "Lancer un tournoi", NewTournamentController().start_gamme_controller)
        self.menu.add("auto", "Terminer un tour", NewTournamentController().end_round_controller)
        self.menu.add("auto", "Lancer un tour", NewTournamentController().start_round_controller)
        self.menu.add("auto", "Commentaire sur le tournoi", NewTournamentController().comment_controller)
