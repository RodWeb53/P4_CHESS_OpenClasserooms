...
class Menu:
    ...
    # Fonction pour avoir acces aux option sans toucher au dictionnaire _entries qui est privé dans les vues
    def items(self):
        return self._entries.items()

    # Méthodes __contains__ pour gérer l'opérateur in dans le choix utilisateur de views
